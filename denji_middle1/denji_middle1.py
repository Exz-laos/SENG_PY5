...
@st.cache_data
def load_image_pairs(data_folder="denji_middle1/Data"):
    """
    ...
    """
    front_dir = os.path.join(data_folder, "/Users/thanongphoneanothay/X_KOSEN/YEAR5/EXAM/denji_middle1/Data/front")
    back_dir = os.path.join(data_folder, "/Users/thanongphoneanothay/X_KOSEN/YEAR5/EXAM/denji_middle1/Data/back")
...
# --- UI Layout ---
st.set_page_config(page_title="DigitalSignal_middle1 画像フラッシュカード", layout="wide", page_icon="🧮")
...
# --- Main Flashcard Area ---
st.title("🧮 DigitalSignal_middle1 画像フラッシュカード")
