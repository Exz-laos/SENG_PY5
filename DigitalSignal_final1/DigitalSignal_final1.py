...
@st.cache_data
def load_image_pairs(data_folder="DigitalSignal_final1/Data"):
    """
...
# --- UI Layout ---
st.set_page_config(page_title="DigitalSignal_final1 画像フラッシュカード", layout="wide", page_icon="🧮")
...
with st.sidebar:
    ...
    if total_cards_overall == 0:
        ...
        # セッションステートの値を使用して入力フィールドをDigitalSignal_final1 
...
# --- Main Flashcard Area ---
st.title("🧮DigitalSignal_final1 画像フラッシュカード")
