...
@st.cache_data
def load_image_pairs(data_folder="math_final1/Data"):
    """
...
# --- UI Layout ---
st.set_page_config(page_title="math_final1画像フラッシュカード", layout="wide", page_icon="🧮")
...
# --- Main Flashcard Area ---
st.title("🧮 Math_final1画像フラッシュカード")
