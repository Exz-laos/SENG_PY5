...
@st.cache_data
def load_image_pairs(data_folder="math_middle1/Data"):
    """
    ...
    """
    front_dir = os.path.join(data_folder, "/Users/thanongphoneanothay/X_KOSEN/YEAR5/EXAM/math_middle1/Data/front")
    back_dir = os.path.join(data_folder, "/Users/thanongphoneanothay/X_KOSEN/YEAR5/EXAM/math_middle1/Data/back")
...
# --- UI Layout ---
st.set_page_config(page_title="math_middle1画像フラッシュカード", layout="wide", page_icon="🧮")
...
# --- Main Flashcard Area ---
st.title("🧮 Math_middle1画像フラッシュカード")
