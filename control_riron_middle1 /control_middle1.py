...
@st.cache_data
def load_image_pairs(data_folder="control_riron_middle1 /Data"):
    """
    ...
    """
    front_dir = os.path.join(data_folder, "/Users/thanongphoneanothay/X_KOSEN/YEAR5/EXAM/control_riron_middle1 /Data/front")
    back_dir = os.path.join(data_folder, "/Users/thanongphoneanothay/X_KOSEN/YEAR5/EXAM/control_riron_middle1 /Data/back")
