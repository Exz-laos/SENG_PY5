...
def load_image_pairs(data_folder="control_middle1/Data"):
    ...
    """
    front_dir = os.path.join(data_folder, "/Users/thanongphoneanothay/X_KOSEN/YEAR5/EXAM/DigitalSignal_middle1 /Data/front")
    back_dir = os.path.join(data_folder, "/Users/thanongphoneanothay/X_KOSEN/YEAR5/EXAM/DigitalSignal_middle1 /Data/back")
...
with st.sidebar:
    ...
    if total_cards_overall == 0:
        ...
        # セッションステートの値を使用して入力フィールドをDigitalSignal_middle1 
